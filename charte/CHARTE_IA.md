...
⚠️ La forme se prend au volet des pages patristiques, qui est le modèle : le nom en vert qui ouvre la fiche, puis ce qu’on lit, puis les repères, à une seule interligne (1,35). Deux volets de lecture ne se composent pas chacun à sa façon.
