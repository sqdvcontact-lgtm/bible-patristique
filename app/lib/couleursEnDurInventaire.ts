...
export const COULEURS_EN_DUR: Record<string, readonly string[]> = {
  ...
  'admin/SectionOuvrages.tsx': ['#6f8a3e'],
  ...
  'components/CitationPreferee.tsx': ['#8201'],
  ...
  'essais/EssaisListeClient.tsx': ['#8201', '#9a5a2a', '#a02d2d', '#c8d8cc', '#fff', 'rgba(0,0,0,0)', 'rgba(120,110,96,0.06)', 'rgba(154,90,42,0.075)', 'rgba(154,90,42,0.24)', 'rgba(160,45,45,0.08)', 'rgba(160,45,45,0.25)', 'rgba(255,255,255,0)', 'rgba(40,30,15,0.18)', 'rgba(40,30,15,0.22)', 'rgba(40,30,15,0.40)', 'rgba(40,30,15,0.48)'],
  ...
  'pericopes/[id]/page.tsx': ['#8239'],
  'pericopes/PericopesCatalogueClient.tsx': ['#8239'],
  'polyglotte/page.tsx': ['rgba(90,75,156,0.22)'],
  'prelevements/page.tsx': ['#8201'],
  'profil/[pseudo]/page.tsx': ['#7a8a6e', '#8201', '#c8a858', '#c8c0b8', '#e2c98d', '#e2ca91', '#e4cc91', '#e4d7b6', '#ead9a9', 'rgba(198,169,100,.42)', 'rgba(222,190,111,.18)', 'rgba(222,190,111,.20)', 'rgba(222,190,111,.34)', 'rgba(233,204,136,.24)', 'rgba(233,204,136,.28)', 'rgba(233,204,136,.30)', 'rgba(235,218,175,.46)', 'rgba(235,218,175,.7)'],
