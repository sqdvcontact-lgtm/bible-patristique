...
export const COULEURS_EN_DUR: Record<string, readonly string[]> = {
  ...
  'bibliotheque/BibliothequeClient.tsx': ['#4a4030', '#7a6a48', '#7a8a6a', '#8a7a5a', '#a2564a', '#b0442a', '#b87a30', '#b88a45', '#b8a888', '#cfe0d5', 'rgba(139,107,60,0.05)', 'rgba(139,107,60,0.08)', 'rgba(139,107,60,0.22)', 'rgba(30,26,20,0.42)', 'rgba(30,26,20,0.55)'],
  ...
  'profil/[pseudo]/page.tsx': ['#c8a858', '#e2ca91', '#e4cc91', '#e4d7b6', 'rgba(198,169,100,.42)', 'rgba(222,190,111,.18)', 'rgba(222,190,111,.20)', 'rgba(222,190,111,.34)', 'rgba(233,204,136,.24)', 'rgba(233,204,136,.28)', 'rgba(233,204,136,.30)', 'rgba(235,218,175,.46)', 'rgba(235,218,175,.7)'],
