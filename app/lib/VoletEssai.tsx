...
export default function VoletEssai({ element, onFermer, toujoursVisible, inline, enTete, editionNote, onEnregistrerNote }: Props) {
        ...
        <>
          ...
          {chargement ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <button onClick={() => onEnregistrerNote(texteNote)} style={{ alignSelf: 'flex-end', fontSize: '0.71875rem', padding: '6px 14px', borderRadius: '5px', border: 'none', background: '#3d6b4f', color: '#fff', cursor: 'pointer', fontWeight: 600 }}>
  ...
  return (
    <div style={{
      position: 'fixed', top: '48px', right: 0, width: '20rem', height: 'calc(100vh - 48px)',
