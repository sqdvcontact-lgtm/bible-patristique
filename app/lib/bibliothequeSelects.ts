...
export const SELECT_OEUVRES_BIBLIOTHEQUE =
  'id_oeuvre, id_auteur, titre, sous_titre, titre_original, editeur, trad_auteur, ville, date_publication_affichage_courte, date_publication_precision_affichage, genre, acces_public, langue_originale, langue_trad, nb_signes'
