  ...
  return createPortal(
    <div onClick={onClose} className="auteur-modale-overlay"
      /* La fenêtre commence SOUS la navbar (fixe), et le calque NE DÉFILE PAS.
         ⚠️ En `inset: 0` avec un calque défilant, le contenu passait sous la barre,
         qui est peinte par-dessus. C'est le CONTENU de la boîte qui défile
         désormais ; la boîte garde toujours sa marge en haut comme en bas, quelle
