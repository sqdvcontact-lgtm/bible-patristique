          ...
          <>
            <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: '16px 14px 8px' }}>
              {messages === null ? (
                ...
                <p style={{ textAlign: 'center', fontSize: '0.78125rem', color: 'var(--cs-texte-doux)', fontStyle: 'italic', marginTop: '24px' }}>Début de votre conversation avec {pseudoActif}.</p>
              ) : (
                    ...
                    <button key={c.partenaire_pseudo} onClick={() => ouvrirConversation(c.partenaire_pseudo)}
                      ...
                      <span style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3px' }}>
                        <span style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                          <span style={{ fontFamily: SERIF, fontSize: '0.875rem', color: 'var(--cs-encre-fonce)', fontWeight: c.nb_non_lus > 0 ? 600 : 400 }}>
                            {c.partenaire_pseudo}
