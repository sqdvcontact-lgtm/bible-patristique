  ...
  return (
    <button
      ...
      style={{
        ...
        color: actif ? '#c8933a' : 'var(--cs-texte-faible)',
      ...
      onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = actif ? '#c8933a' : 'var(--cs-texte-faible)'; (e.currentTarget as HTMLElement).style.transform = 'scale(1)' }}
    >
