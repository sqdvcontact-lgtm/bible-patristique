...
// ⛔ DES FORMES PLEINES, TOUTES (relevé de l'auteur, 2026-09-23 : « autant X me paraît
// clean, autant les autres logos sont moches »). Le trait de Lucide, rendu à 1 rem sur
// un écran à 125 %, tombait entre deux pixels et se brouillait ; une forme pleine garde
// un bord net. Le lien, le courriel et la bulle sont ceux de Material Icons (Apache 2.0),
// dessinés sur la grille de 24 ; le « f » nu est celui de Font Awesome (CC BY 4.0), sans
// cercle, comme le X ; WhatsApp reprend sa marque à pleine boîte.
const MARQUES: Record<CleCanal, React.ReactNode> = {
  lien: <path fill="currentColor" d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z" />,
  courriel: <path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />,
  sms: <path fill="currentColor" d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" />,
  ...
  facebook: <path fill="currentColor" transform="translate(4.5 0) scale(0.046875)" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />,
