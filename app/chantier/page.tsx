...
const PHASES: { titre: string; etat: "fait" | "avant" | "apres"; items: string[] }[] = [
  { titre: "Déjà en place", etat: "fait", items: [
    "Plus de trente œuvres déjà accessibles dans la bibliothèque",
    "Six corpus bibliques, du français moderne au latin, au grec ancien et à l’ancien français",
    "Lecture simple ou polyglotte",
    "Renvois entre la Bible et les textes patristiques",
    "Péricopes, catalogue et frise chronologique",
    "Favoris, comptes, commentaires et publications des lecteurs",
    "Moteur de recherche",
  ] },
  { titre: "Avant l’ouverture", etat: "avant", items: [
    "Poursuivre la relecture éditoriale des œuvres déjà accessibles",
    "Achever les collations et contrôles des corpus bibliques",
    "Publier progressivement les textes originaux latins et grecs déjà préparés",
    "Clore les derniers contrôles de la Bible française du XIIIe siècle",
    "Faire passer la Bible de Fillion du pilote à une édition complète",
    "Achever la validation des péricopes et consolider leur bibliographie",
    "Tester et corriger l’ensemble du site, notamment sur mobile",
  ] },
  { titre: "Après l’ouverture", etat: "apres", items: [
    "Enrichir la bibliothèque patristique de nouveaux auteurs et de nouvelles éditions",
    "Ajouter de nouvelles traductions et éditions bibliques",
    "Étendre la lecture aux autres langues anciennes, notamment l’hébreu et le syriaque",
    "Intégrer progressivement les apocryphes et autres corpus anciens",
    "Développer les correspondances entre les textes et approfondir la recherche",
    "Corriger les erreurs signalées et documenter les choix éditoriaux",
    "Développer les contributions et la communauté des lecteurs",
  ] },
];
