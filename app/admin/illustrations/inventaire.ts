...
export const ILLUSTRATIONS: Illustration[] = [
  ...
  },
  {
    ...
    nom: 'Carapace posée',
    fonction: 'blanc',
    emploi: 'Dit qu’un passage n’a encore reçu aucun commentaire, dans le volet de droite d’une œuvre comme dans celui de la Bible.',
    lieu: { href: '/?livre=NUM&chapitre=7&verset=1&trad=TR0001', label: 'Nombres 7, 1', repere: 'Volet de droite, onglet « Commentaires » : le verset visé n’a encore reçu aucun commentaire.' },
  ...
  },
  {
    ...
    fonction: 'blanc',
    emploi: 'Suit « Aucune occurrence. » dans le volet des Pères, quand aucun Père ne cite ni ne commente le passage désigné : il ferme la mention sans illustrer l’absence.',
