...
export const ILLUSTRATIONS: Illustration[] = [
  ...
  // ── Porter l'identité ──────────────────────────────────────────────────────
  {
    ...
    fonction: 'identite',
    emploi: 'Le tracé du monogramme CS. En tête de l’accueil, il ne sert plus que d’ALPHA : il y est posé en MASQUE, et c’est le fond de l’élément qui donne la couleur — l’encre douce au Clair, le crème au Cuir. Une seule planche suffit donc aux deux thèmes, les deux canaux alpha étant identiques au pixel près.',
    lieu: { href: '/accueil', label: 'Accueil', repere: 'Tout en tête, au-dessus du titre, dans les deux thèmes.' },
    source: 'app/accueil/page.tsx',
  ...
  },
  {
    ...
    fonction: 'identite',
    emploi: 'Le même tracé en crème. Sert de retour à l’accueil dans la barre de navigation, dans les deux thèmes. L’accueil, lui, ne l’emploie plus : il masque la planche d’encre et la peint.',
