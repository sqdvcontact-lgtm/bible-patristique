...
export const ILLUSTRATIONS: Illustration[] = [
...

  {
    ...
    fonction: 'reserve',
    emploi: 'Tenait la page de recherche avant toute requête ; retirée le 21 septembre 2026 sur décision de l’auteur (« supprime la tortue, l’arbre, etc. ; et remplace ») au profit d’un fleuron du registre, posé par app/components/FleuronDiscret.tsx. La planche demeure au dépôt, sans emploi.',
...

  {
    ...
    nom: 'Arbre ardent',
    fonction: 'reserve',
    emploi: 'A tenu le volet de droite d’une œuvre resté vide, au-dessus de l’invite « Cliquez sur un paragraphe. », du 26 août au 15 septembre 2026. Retiré sur décision de l’auteur (« supprimer l’arbre, garder centré ») : l’invite seule reste, centrée dans le volet. La planche demeure au dépôt, sans emploi.',
    traitement: { opacite: 0.42, ornement: true },
  ...
  },
  {
    ...
    fonction: 'reserve',
    emploi: 'Disait, dans le volet de droite d’une œuvre, qu’un paragraphe ne porte aucun lien biblique ; retirée le 21 septembre 2026 sur décision de l’auteur (« supprime la tortue, l’arbre, etc. ; et remplace ») au profit d’un fleuron du registre, posé par app/components/FleuronDiscret.tsx. La planche demeure au dépôt, sans emploi.',
    traitement: { opacite: 0.42, ornement: true },
    note: 'A été dessinée pour répondre à l’arbre ardent du même volet, dont elle reprend la mesure ; l’arbre ardent a quitté le volet resté vide le 15 septembre 2026, sur décision de l’auteur, et celle-ci reste la seule planche du volet. L’arbre est ici mort et le corbeau seul — l’absence se dit par l’image avant de se dire par la phrase. Le plafond de hauteur réserve 13,5 rem au lieu de 11,5 : le bouton de proposition se pose sous l’invite et sortirait de l’écran sur une fenêtre basse. Fabriquée par la chaîne commune aux gravures du 2026-08-26 : pourtour de la source rogné, papier ramené au blanc d’après son niveau DOMINANT, détourage, puis encre reposée en une teinte unique à la luminance 33, celle de la tour de Babel ruinée. ⚠️ L’ALPHA se calcule sur l’encre REPOSÉE, non sur la médiane de la planche : les deux ne s’accordent plus dès qu’on repose une encre plus sombre, et tout le dégradé qui borde un trait s’assombrit alors — un gris à 180 rendait 136. Écart moyen au dessin d’origine ramené à 1 niveau. ⛔ Le FICHIER est servi à deux fois sa taille d’affichage, jamais plus : au delà, le navigateur réduit une seconde fois derrière la nôtre, et deux réductions successives moyennent les hachures fines en un gris mou. La cité s’affichait à 549 px dans une colonne de 620 pour un fichier de 1 600, soit 2,9 fois trop — c’est ce qui la rendait baveuse quand la tour, servie au double exact, restait nette. La taille d’affichage se calcule à la racine 22, la plus grande que la police fluide atteigne, et un léger rattrapage de netteté compense la seule réduction qui reste.',
  },
  {
    chemin: '/ornements/carapace-posee.png',
    nom: 'Carapace posée',
    fonction: 'reserve',
    emploi: 'Disait, dans les volets de commentaires de la Bible et d’une œuvre, qu’un passage n’avait reçu aucun commentaire ; retirée le 21 septembre 2026 sur décision de l’auteur (« supprime la tortue, l’arbre, etc. ; et remplace ») au profit d’un fleuron du registre, posé par app/components/FleuronDiscret.tsx. La planche demeure au dépôt, sans emploi.',
    traitement: { opacite: 0.42, ornement: true },
    note: 'Deux poses, une seule planche : les deux volets de commentaires, celui de la Bible et celui d’une œuvre, ce dernier dans app/oeuvre/[id]/OngletCommentaires.tsx. ⛔ Elle a quitté le « Aucune occurrence » de l’apparat le 14 septembre 2026 (décision de l’auteur : « supprimer le dessin de tortue ; conserver “Aucune occurrence” au centre ») : la mention y reste au centre de la colonne, et un petit fleuron la suit depuis le soir même (« Fleuron — volutes, en petit »). Elle a remplacé la carapace couchée, qui disait la même absence sous un autre dessin selon la page où l’on se trouvait. Dans les deux volets de commentaires elle se pose au MILIEU de la zone défilante, en largeur comme en hauteur ; cette hauteur vient du flux, la zone étant déjà « flex: 1 ». Fabriquée par la chaîne commune aux gravures du 2026-08-26 : pourtour de la source rogné, papier ramené au blanc d’après son niveau DOMINANT, détourage, puis encre reposée en une teinte unique à la luminance 33, celle de la tour de Babel ruinée. ⚠️ L’ALPHA se calcule sur l’encre REPOSÉE, non sur la médiane de la planche : les deux ne s’accordent plus dès qu’on repose une encre plus sombre, et tout le dégradé qui borde un trait s’assombrit alors — un gris à 180 rendait 136. Écart moyen au dessin d’origine ramené à 1 niveau. ⛔ Le FICHIER est servi à deux fois sa taille d’affichage, jamais plus : au delà, le navigateur réduit une seconde fois derrière la nôtre, et deux réductions successives moyennent les hachures fines en un gris mou. La cité s’affichait à 549 px dans une colonne de 620 pour un fichier de 1 600, soit 2,9 fois trop — c’est ce qui la rendait baveuse quand la tour, servie au double exact, restait nette. La taille d’affichage se calcule à la racine 22, la plus grande que la police fluide atteigne, et un léger rattrapage de netteté compense la seule réduction qui reste.',
  },
  {
...

  {
    ...
    fonction: 'reserve',
    emploi: 'Fermait le message de la Polyglotte ouverte sur un petit écran ; retirée le 21 septembre 2026 sur décision de l’auteur (« supprime la tortue, l’arbre, etc. ; et remplace ») au profit d’un fleuron du registre, posé par app/components/FleuronDiscret.tsx. La planche demeure au dépôt, sans emploi.',
    traitement: { opacite: 0.92, ornement: true },
  ...
  {
    chemin: '/ornements/fleuron-arbre-clochettes-fillion.png',
    nom: 'Fleuron — arbre aux clochettes de Fillion',
    fonction: 'coiffer',
    emploi: "Copie ornementale de l’illustration fillion-t02-1sa-p0263-i01, offerte au choix du fleuron d’une œuvre sans retirer ni modifier l’illustration biblique d’origine.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'fillion-t02-1sa-p0263-i01 ; app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '4.125rem', sol: 'papier' } },
    note: "Copie au format symbole-fleuron demandée par l’auteur le 11 septembre 2026. Les poussières isolées et la longue ligne de sol ont été ôtées sans invention de dessin ; la planche de 68 × 132 px est servie au double de sa hauteur d’affichage.",
  },
  {
  ...
  {
    chemin: '/ornements/fleuron-quadrilobe.png',
    nom: 'Fleuron — quadrilobe',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Quatre lobes égaux, chacun marqué d’une croisette : la rosace du remplage gothique, celle-là même dont le site a tiré sa marque de liste. Symétrique sur ses deux axes. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 90 × 89 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-lys-flamboyant.png',
    nom: 'Fleuron — lys flamboyant',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Trois flammes issues d’un pied fleuronné — entre le lys et le feu, et symétrique sur son axe vertical. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 63 × 87 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-roue.png',
    nom: 'Fleuron — roue ornée',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Roue à huit rais, moyeu fleuri, jante semée de croisettes. Ronde, donc sans direction. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 95 × 96 pour une pose de 3rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-rosace.png',
    nom: 'Fleuron — rosace',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Rosace à rinceaux, la plus DENSE du registre : un quart de son plan est de l’encre pleine. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.25rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 107 × 104 pour une pose de 3.25rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-rayon-miel.png',
    nom: 'Fleuron — rayon de miel',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Cartouche feuillagé sur un rayon d’abeilles, une goutte au pied. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.875rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 71 × 91 pour une pose de 2.875rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-calice.png',
    nom: 'Fleuron — calice',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Calice plein, sans ornement : la silhouette la plus simple du registre, et elle se lit petite. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 48 × 80 pour une pose de 2.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-encensoir.png',
    nom: 'Fleuron — encensoir',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Encensoir suspendu, sa fumée montant en deux volutes. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 68 × 111 pour une pose de 3.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-lyre-feuillagee.png',
    nom: 'Fleuron — lyre feuillagée',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Lyre entre deux rinceaux d’acanthe, symétrique sur son axe vertical. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 83 × 89 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-lyre.png',
    nom: 'Fleuron — lyre',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Lyre à balustre, croisette en tête et pendant au pied — la plus aérée des deux lyres. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 56 × 97 pour une pose de 3rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-trompette.png',
    nom: 'Fleuron — trompette',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Trompette droite à corde enroulée. C’est le seul ornement COUCHÉ du registre : deux fois plus large que haut, d’où sa pose courte. ⚠️ Elle est FIGURATIVE et tournée vers la droite : elle regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 127 × 65 pour une pose de 2rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-epee.png',
    nom: 'Fleuron — épée feuillagée',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Épée haute prise dans un feuillage, un mascaron à la garde. Symétrique sur son axe vertical. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 58 × 97 pour une pose de 3rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-cognee.png',
    nom: 'Fleuron — cognée',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Cognée plantée dans une souche, sur un sol hachuré — « déjà la cognée est à la racine des arbres » (Mt 3, 10). Le plus léger du lot : moins de trois pour cent d’encre pleine. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 134 × 89 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-echelle-serpents.png',
    nom: 'Fleuron — échelle aux serpents',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Deux serpents enlacés le long d’une échelle. Le plus ÉTROIT du registre, presque trois fois plus haut que large. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.25rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 38 × 104 pour une pose de 3.25rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-serpent-airain.png',
    nom: 'Fleuron — serpent d’airain',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Serpent dressé sur un tau : le serpent d’airain du désert (Nb 21, 9), que la tradition lit comme figure de la croix. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.25rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 56 × 104 pour une pose de 3.25rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-ailes.png',
    nom: 'Fleuron — ailes déployées',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Paire d’ailes déployées, plume à plume. Symétrique sur son axe vertical, et large : à sa pose elle couvre deux fois la mesure d’un fleuron ordinaire. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 137 × 81 pour une pose de 2.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-soleil.png',
    nom: 'Fleuron — soleil',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Soleil à visage, rayons droits et flammés alternés. Rond, donc sans direction. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 98 × 96 pour une pose de 3rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-corbeau.png',
    nom: 'Fleuron — corbeau',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Corbeau posé, la patte sur un crâne — celui d’Élie au torrent de Carith autant que celui des vanités. ⚠️ Il est FIGURATIF et tourné vers la droite : il regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 88 × 89 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-cerf.png',
    nom: 'Fleuron — cerf',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Tête de cerf de face, ramure haute — « comme le cerf soupire après les sources » (Ps 41, 2). De face, donc il ne regarde nulle part qu’au lecteur. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.25rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 75 × 105 pour une pose de 3.25rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-aigle.png',
    nom: 'Fleuron — aigle',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Tête d’aigle en silhouette pleine, l’emblème de Jean. ⚠️ Elle est FIGURATIVE et tournée vers la gauche : elle regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 92 × 87 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-pelican.png',
    nom: 'Fleuron — pélican',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Pélican aux ailes ouvertes sur son nid : le pélican mystique, qui nourrit ses petits de son sang. ⚠️ Il est FIGURATIF et tourné vers la droite : il regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 98 × 96 pour une pose de 3rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  ...
  {
    chemin: '/ornements/fleuron-taureau.png',
    nom: 'Fleuron — taureau',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Tête de taureau de face, en silhouette pleine : l’emblème de Luc. Dense, donc posée court. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 84 × 79 pour une pose de 2.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-main.png',
    nom: 'Fleuron — main feuillagée',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Main levée d’où sort un rinceau d’acanthe. ⚠️ Elle est FIGURATIVE et tournée vers la droite : elle regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '2.75rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 72 × 89 pour une pose de 2.75rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-fournaise.png',
    nom: 'Fleuron — fournaise',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Trois figures debout dans les flammes : les trois jeunes gens de la fournaise (Dn 3). Sa pose est haute parce que les trois figures s’y jouent en quelques pixels. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 81 × 113 pour une pose de 3.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
  {
    chemin: '/ornements/fleuron-ange-dechu.png',
    nom: 'Fleuron — ange déchu',
    fonction: 'coiffer',
    emploi: "Offert au choix du fleuron d’une œuvre, dans le panneau de la roulette du volet. Figure ailée renversée, tombant la tête la première — « je voyais Satan tomber du ciel comme la foudre » (Lc 10, 18). Le plus difficile à lire du lot, d’où la pose la plus haute. ⚠️ Elle est FIGURATIVE et orientée : elle regarde quelque part, ce qu’un ornement de séparation ne fait pas — à choisir en connaissance de cause. Livré le 20 septembre 2026 avec les vingt-quatre autres symboles.",
    lieu: { href: '/oeuvre/A0010O0100', label: 'Annotations sur le livre de Job', repere: 'Entre le colophon de la page de titre et le premier titre de division. Le choix se prend à la roulette du volet, onglet « Fleuron ».' },
    source: 'app/lib/fleurons.ts',
    traitement: { masque: true, pose: { hauteur: '3.5rem', sol: 'papier' } },
    note: "Fabriquée par la chaîne commune (scripts/ornements-detourer.mjs, option --recadrer), servie en 76 × 111 pour une pose de 3.5rem de haut — une planche se sert au double de sa taille d’affichage, jamais plus. ⚠️ Sa hauteur de pose est MESURÉE, à la taille réelle, sur planche agrandie au plus proche voisin, sur les deux sols. ⛔ La changer oblige à rejouer la planche. Le registre, ses dimensions et sa garde vivent dans app/lib/fleurons.ts. La planche brute est conservée dans tmp/fleurons-source-20260920/, hors dépôt, et sa copie de chaîne dans C:\\Corpus Scriptura\\ornements-originaux-20260823.",
  },
