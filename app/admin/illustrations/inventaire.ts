...
export const ILLUSTRATIONS: Illustration[] = [
  ...
  // ── Illustrer une carte ────────────────────────────────────────────────────
  {
    chemin: '/icons/accueil-bible.png',
    nom: 'Bible ouverte',
    fonction: 'carte',
    emploi: 'Carte « Bible » de l’accueil. Gravure de l’auteur, réduite à son alpha et posée en masque.',
    ...
    traitement: { masque: true, largeur: '5.75 × 2.65 rem' },
  },
  {
    chemin: '/icons/accueil-patristique.png',
    nom: 'Père de l’Église',
    fonction: 'carte',
    emploi: 'Carte « Patristique » de l’accueil. Buste de profil, gravure de l’auteur posée en masque.',
    lieu: { href: '/accueil#cartes', label: 'Accueil, les trois cartes', repere: 'Deuxième des trois cartes, sous le frontispice.' },
    source: 'app/components/AccueilCards.tsx',
    traitement: { masque: true, largeur: '3.5 × 4.75 rem' },
  },
  {
    chemin: '/icons/accueil-communaute.png',
    nom: 'Deux lecteurs',
    fonction: 'carte',
    emploi: 'Carte « Communauté » de l’accueil. Gravure de l’auteur posée en masque.',
    lieu: { href: '/accueil#cartes', label: 'Accueil, les trois cartes', repere: 'Troisième des trois cartes, sous le frontispice.' },
    source: 'app/components/AccueilCards.tsx',
    traitement: { masque: true, largeur: '4.75 × 4.75 rem' },
  },

  {
    chemin: '/icons/home-bible-book.png',
    nom: 'Livre ouvert (ancienne carte)',
    fonction: 'reserve',
    emploi: 'Ancienne illustration de la carte « Bible », remplacée le 2026-08-26 par une gravure de l’auteur.',
  },
  {
    chemin: '/icons/home-patristique-buste.png',
    nom: 'Buste de Père (ancienne carte)',
    fonction: 'reserve',
    emploi: 'Ancienne illustration de la carte « Patristique », remplacée le 2026-08-26 par une gravure de l’auteur.',
  },
  {
    chemin: '/icons/home-publications-writing.png',
    nom: 'Main qui écrit (ancienne carte)',
    fonction: 'reserve',
    emploi: 'Ancienne illustration de la carte « Communauté », remplacée le 2026-08-26 par une gravure de l’auteur.',
  },
