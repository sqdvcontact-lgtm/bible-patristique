  ...
  return (
    <div className="controle-oeuvres">
      <style>{`
        ...
        .stat-btn.active{background:var(--cs-vert-aplat-fonce);color:var(--cs-sur-aplat);border-color:var(--cs-vert-fonce);}
        ...
        .mode-btn.active{background:var(--cs-vert-pale);border-color:var(--cs-vert-aplat);color:var(--cs-vert-fonce);font-weight:700;}
