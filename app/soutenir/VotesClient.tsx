...
const TAG_COULEUR: Record<string, { fond: string; texte: string }> = {
  'Gratuit':    { fond: 'rgba(var(--cs-vert-rgb),0.10)',  texte: 'var(--cs-vert-fonce)' },
  ...
  return (
    <section style={{ maxWidth: '40rem', width: '100%', margin: '0 auto', padding: '64px 24px 80px' }}>
      <div style={{ textAlign: 'center', marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '0.84375rem', color: 'var(--cs-vert-fonce)', lineHeight: 1.72, margin: 0 }}>
          ...
          {PROPOSITIONS.map(p => {
            ...
            return (
              <div key={p.id} style={{
                ...
                border: `1px solid ${vote ? 'rgba(var(--cs-vert-rgb),0.34)' : 'var(--cs-bord)'}`,
                borderRadius: '8px',
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px', flexWrap: 'wrap' }}>
                    <span style={{
                      fontFamily: "var(--font-source-serif), Georgia, serif",
                      fontSize: '0.875rem', color: 'var(--cs-encre-fonce)', fontWeight: 'normal',
                    }}>
                      {p.titre}
                    </span>
                    {p.tag && tag && (
