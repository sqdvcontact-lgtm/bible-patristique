    ...
    <main style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '52px' }}>
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
          style={{ marginBottom: "28px", opacity: 0.55 }} aria-hidden="true">
          <path d="M20 35S4 24 4 13a8 8 0 0 1 16-2 8 8 0 0 1 16 2c0 11-16 22-16 22z"
            stroke="#3d6b4f" strokeWidth="1.6" fill="none" strokeLinejoin="round" />
        </svg>

        <h1 style={{
          fontFamily: "Georgia, 'Times New Roman', serif",
          fontSize: "clamp(22px, 3vw, 30px)",
          fontWeight: "normal", color: "#2a3d30", marginBottom: "20px",
        }}>
          Soutenir le projet
        </h1>

        <p style={{
          fontSize: "14px", color: "#5a6b5e", lineHeight: 1.75,
        ...
        <a href={LIEN_PAYPAL} target="_blank" rel="noopener noreferrer"
          style={{
            ...
            fontSize: "14.5px", fontWeight: 500, padding: "13px 30px",
            borderRadius: "8px", boxShadow: "0 4px 14px rgba(61,107,79,0.25)",
          }}>
        ...
        <p style={{
          fontSize: "11.5px", color: "#9a958d", marginTop: "18px", fontStyle: "italic",
        }}>
