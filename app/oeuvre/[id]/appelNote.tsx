...
// `titreSansAppelsDeNote`, dans `intituleSommaire.tsx`.
...
// L'intitulé de sommaire — sans appels de note, enrichi — vit dans `intituleSommaire.tsx`,
// module neutre : la tête d'un renvoi de note à note l'emploie aussi, et elle est rendue
// DANS une note. Réexporté ici pour les appelants historiques de la page d'œuvre.
export { intituleEnTexteNu, rendreIntituleDeSommaire, titreSansAppelsDeNote } from './intituleSommaire'
