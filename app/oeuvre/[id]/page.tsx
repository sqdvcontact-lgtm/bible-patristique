...
export default async function OeuvrePage({
  ...
  return (
    ...
    <OeuvreClient
      ...
      fleuron={oeuvre.fleuron ?? null}
      lectureTexteEntier={lectureTexteEntier}
      titresComposes={oeuvre.titres_composes ?? null}
      oeuvre={{titre:oeuvre.titre,titre_affichage:oeuvre.titre_affichage,sous_titre:oeuvre.sous_titre,sous_titre_affichage:oeuvre.sous_titre_affichage,titre_original:oeuvre.titre_original,titre_original_affichage:oeuvre.titre_original_affichage,auteur_affichage:oeuvre.auteur_affichage,trad_auteur:oeuvre.trad_auteur,trad_auteur_affichage:oeuvre.trad_auteur_affichage,provenance_affichage:oeuvre.provenance_affichage,trad_date:oeuvre.trad_date,commentaire_traduction:oeuvre.commentaire_traduction,note_editoriale_complete:oeuvre.note_editoriale_complete,note_editoriale_complement:oeuvre.note_editoriale_complement,bibliographie_selective:oeuvre.bibliographie_selective,note_editoriale_titre:oeuvre.note_editoriale_titre,editeur:oeuvre.editeur,collection:oeuvre.collection,ville:oeuvre.ville,date_publication:oeuvre.date_publication,date_mise_en_ligne:oeuvre.date_mise_en_ligne,id_oeuvre:oeuvre.id_oeuvre,date_composition:oeuvre.date_composition,langue_originale:oeuvre.langue_originale,genres:oeuvre.genres,url_source:oeuvre.url_source,nb_signes:oeuvre.nb_signes}}
