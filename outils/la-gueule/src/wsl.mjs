...
// (rendrePlanches — rendu des planches de vignettes pour le tri IA — retiré le 2026-08-10 avec la
//  fonction « Trier les pages (IA) ». La détection des pages inutiles se fait après OCR, déterministe.)
