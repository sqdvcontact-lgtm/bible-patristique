/**
 * § 37 : le fond du volet déplié prend un TON de l'encart. Décision de l'auteur
 * du 27 août 2026.
 *
 * ⛔ N'écrit QUE dans `parametres.charte_ia` ; le miroir s'en régénère.
 * Usage : node scripts/charte-ton-encart-2026-08-27.mjs [--dry]
 */
...
if (avant.includes('prend un TON de son encart')) throw new Error('La règle du ton est déjà posée : rien n’est écrit.')
