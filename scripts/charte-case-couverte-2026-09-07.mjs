/**
 * Charte — § 38.29 : une case couverte n'est pas une case vide.
 *
 ...
 *
 *   node --env-file=.env.local scripts/charte-case-couverte-2026-09-07.mjs [--ecrire]
 */
...
const CLE = 'charte_ia'
const SAUVEGARDE = 'charte_ia_sauvegarde_20260907_case_couverte'
...
const SECTION = readFileSync(new URL('./charte-38-29-case-couverte.md', import.meta.url), 'utf8')
...
if (distant.includes('### 38.29 Une case COUVERTE')) {
  console.log('⚠️  La section § 38.29 est déjà dans la charte : rien à faire.')
  process.exit(0)
}
...
console.log(`ajout  : ${SECTION.length} signes (§ 38.29)`)
