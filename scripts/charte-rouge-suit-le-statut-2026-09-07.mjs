 ...
 *
 *   node --env-file=.env.local scripts/charte-rouge-suit-le-statut-2026-09-07.mjs [--ecrire]
 */
...
const CLE = 'charte_ia'
const SAUVEGARDE = 'charte_ia_sauvegarde_20260907_rouge_statut'
...
const SECTION = readFileSync(new URL('./charte-38-28-rouge-suit-le-statut.md', import.meta.url), 'utf8')
