/**
 * Charte — § 12.3 : une colonne EN REGARD se compose sur la surface qui rend le texte.
 *
 ...
 *
 *   node --env-file=.env.local scripts/charte-regard-sur-toute-surface-2026-09-07.mjs [--ecrire]
 */
...
const CLE = 'charte_ia'
const SAUVEGARDE = 'charte_ia_sauvegarde_20260907_regard_surface'
...
const SECTION = readFileSync(new URL('./charte-12-3-regard-surface.md', import.meta.url), 'utf8')
...
if (distant.includes('### 12.3 UNE COLONNE EN REGARD')) {
  console.log('⚠️  La section § 12.3 est déjà dans la charte : rien à faire.')
  process.exit(0)
}
...
console.log(`ajout  : ${SECTION.length} signes (§ 12.3)`)
