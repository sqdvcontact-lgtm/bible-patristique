...
function parseArgs() {
  ...
  if (!args.data || !args.snapshot || !args.review) {
    throw new Error('Usage: node build-alignment-fine.mjs --data data-dir --snapshot mirandol.json --review review-dir');
  }
...
const mirSnapshotPath = args.snapshot;
...
const set = {
  ...
  method: 'semantic_division_dp_v2_fine_boundary_review',
  status: 'candidate',
  is_public: false,
...
set.method = 'semantic_division_dp_v2_fine_boundary_review';
