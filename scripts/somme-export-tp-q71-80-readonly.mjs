...
const PAGE = 100;
const questions = Array.from({ length: 10 }, (_, i) => `Question ${71 + i}`);
...
const raw = {
  ...
  links,
  witnesses,
  special_v2: specialV2,
};
writeFileSync(`${ROOT}/tp-q71-80-raw.json`, `${JSON.stringify(raw, null, 2)}\n`);
