...
const questions = Array.from({ length: 10 }, (_, index) => `Question ${index + 1}`), segments = [], pagination = [];
...
writeFileSync('tmp/somme-liens-audit-2026-07-29/tp-q1-10-raw.json', `${JSON.stringify(output, null, 2)}\n`);
