...
Le nom officiel du site est « Corpus Scriptura » (anciennement « Bible & Tradition patristique » / labibledesperes.com — tout résidu des anciens noms dans le code est à corriger). Domaines acquis via OVH (juillet 2026) : corpus-scriptura.com (canonique) et corpus-scriptura.fr (redirection). Plateforme érudite francophone, en version bêta, croisant le texte biblique et le commentaire patristique. Sébastien Quinson en est le seul développeur — forte culture théologique patristique, compétences techniques limitées.
...
## 9. Liens bibliques (lien_1 à lien_4)
