...
## Les quatre menus déroulants paraissent aussitôt, mais ne se FIXENT qu'après une demi-seconde (2026-08-30)

Doctrine à la charte, § 18 (« Un menu déroulant paraît aussitôt, mais ne se FIXE qu'après une demi-seconde »). Ce qui suit en est l'implémentation, dans `app/components/Navbar.tsx`.
...
- **`useMenuSurvol`** tient l'état, en DEUX TEMPS. L'entrée sur l'onglet ouvre le menu **sans délai** ; une minuterie de `DELAI_FIXATION_MS` (500 ms) le déclare ensuite *fixé*. Le drapeau `fixe` est une **référence**, non un état : la fixation ne change rien à ce qui est dessiné, en faire un état ferait re-rendre la barre une demi-seconde après chaque survol.
