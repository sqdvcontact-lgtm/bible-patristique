...
- ⛔ **Le menu de bureau se règle sur la plus longue de ses gloses, et le maximum passe de 24 à 27 rem.** Ce n'est pas de l'aisance : à 24 rem, DEUX gloses sur six s'enroulaient et une troisième laissait un mot seul sur sa ligne — les six rangées avaient trois hauteurs, et une liste dont rien ne s'aligne se lit mal. Mesurée à la chasse réelle, la plus longue demande 352 px. ⚠️ C'est un MAXIMUM : la boîte rendra la place le jour où les gloses raccourciront.
