...
- ⚠️ **Le contraste est TESTÉ**, pas supposé : chaque couverture doit opposer son encre à son fond d'au moins 4,5 (WCAG AA). Les quatre teintes sombres portent une encre crème, les deux claires (ocre pâle, crème) l'encre brune des textes. Deux fonds ont dû être assombris pour y satisfaire — l'or du site (`--cs-or`, #9a7a38) ne donnait que 3,8 sous une encre claire, la sauge claire (#7d8f77) 3,3. Ajouter une couleur sans repasser le test, c'est risquer une couverture jolie et illisible.
