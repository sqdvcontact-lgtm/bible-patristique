...
- **Jeu de couvertures** : `app/lib/couverturesEssai.ts` (module pur, 12 tests). **Cinq couleurs** depuis le 2026-08-19, arrêtées ensemble sur une même palette : vert (#3d6b4f), bleu (#3175b2), outremer (#3b45c6), mauve (#a98ad8), ambre (#e7ab49). Les onze teintes sourdes d'avant (crème, vieil or, sauge, bordeaux, brique, indigo, ardoise, sarcelle, terre de Sienne, encre noire) sont retirées : une roue complète donnait à chaque publication une teinte différente et le rayon y perdait son unité. Cinq couleurs franches valent mieux qu'une roue rompue, car deux publications voisines ne se ressemblent alors jamais à demi.
- ⚠️ **Le contraste est TESTÉ**, pas supposé : chaque couverture doit opposer son encre à son fond d'au moins 4,5 (WCAG AA). Une palette toute faite n'y satisfait pas d'elle-même. Sur les cinq, trois ont demandé un réglage. Les trois teintes sombres portent une encre claire ; les deux claires (mauve, ambre) prennent une encre brune plus profonde que celle des textes, #2f2a24 et non #3a3026, qui laissait le mauve à 4,4. Le bleu de la palette (#367dbf) plafonnait à 4,35 sous une encre claire et a été assombri d'un ton. Ajouter ou remplacer une couleur sans repasser le test, c'est risquer une couverture jolie et illisible.
